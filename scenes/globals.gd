...
func save_config() -> void:
	...
	var config := {
		...
		"fullscreen": false, # DisplayServer.window_get_mode() == DisplayServer.WINDOW_MODE_EXCLUSIVE_FULLSCREEN,
...
func new_game() -> void:
	...
	score_medals = 0
	nitro = 5.0
	get_tree().change_scene_to_file("res://scenes/drop/drop_game.tscn")
